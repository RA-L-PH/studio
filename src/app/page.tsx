...
import { ArrowRight, Search, Activity, Zap, Clock, RotateCcw, Monitor } from 'lucide-react';

export default function Home() {
  return (
    <div className="h-screen w-screen overflow-hidden bg-[#0D1012] text-gray-100 font-sans selection:bg-[#17CEA4]/30 selection:text-[#17CEA4] relative">
      ...
      <div className="w-full h-full overflow-y-auto">
        ...
        <header className="sticky top-0 z-50 backdrop-blur-md border-b border-gray-800/40 bg-[#0D1012]/80">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            <div className="flex items-center gap-2 font-mono">
              ...
              <span className="flex flex-col sm:flex-row sm:items-center font-bold tracking-wider leading-none text-left">
                <span className="text-xs sm:text-xl text-white font-bold leading-none">PULSE</span>
                <span className="text-[10px] sm:text-xl text-[#17CEA4] font-bold leading-none sm:ml-1">QUEUE</span>
              </span>
            </div>
            
            <nav className="flex items-center gap-3.5 sm:gap-8 text-xs sm:text-sm font-medium text-gray-400">
        ...
        {/* Hero Section */}
        <section className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-16 md:pt-20 pb-12 md:pb-16 text-center flex flex-col items-center">
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-extrabold text-white tracking-tight max-w-4xl leading-tight font-mono">
        ...
        {/* Tech Stack Banner */}
        <section id="architecture" className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16 border-t border-gray-800/40 text-center">
          <div className="text-[10px] sm:text-xs text-gray-500 font-mono tracking-wider mb-6">BUILT WITH ENTERPRISE-GRADE TECH</div>
          <div className="flex flex-wrap justify-center gap-3 sm:gap-6 md:gap-12 text-xs sm:text-sm font-semibold text-gray-400">
            <div className="flex items-center gap-1.5 border border-gray-800 px-3 py-1.5 rounded-lg bg-gray-900/20">
        ...
        {/* Footer */}
        <footer className="border-t border-gray-900 bg-[#07090a] pt-8 pb-20 sm:pb-8 text-center text-xs text-gray-500">
